    ...
    switch(action.type){
        ...
        case "LOGIN":
                const loadInfo = async () => {
                    const res = await axios.get('http://localhost/React/project8-main/project8-main/reduxproj/php/login.php?email='+state.emailORUsername+'&password='+state.password);
